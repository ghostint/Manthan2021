...
class TopicModel:
    ...
    def __train(self):
        self.__model = LdaModel(self.bow, self.n, passes=40, id2word=self.d,chunksize=100)
    ...
    def predict(self, line):
        ...
        noun_adjs = nouns + adjs # using nouns and adjectives
        ...
        third = self.__predict(word_tokens)
